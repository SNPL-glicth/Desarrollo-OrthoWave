...
export class MakePatientFieldsNullable1753931399873 implements MigrationInterface {
    name = 'MakePatientFieldsNullable1753931399873'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`doctor_schedules\` (\`id\` int NOT NULL AUTO_INCREMENT, \`doctor_id\` int NOT NULL, \`date\` date NOT NULL, \`is_available\` tinyint NOT NULL DEFAULT 1, \`start_time\` time NULL, \`end_time\` time NULL, \`break_start\` time NULL, \`break_end\` time NULL, \`slot_duration\` int NOT NULL DEFAULT '20', \`buffer_time\` int NOT NULL DEFAULT '0', \`custom_slots\` json NULL, \`max_appointments\` int NOT NULL DEFAULT '8', \`notes\` text NULL, \`schedule_type\` enum ('specific', 'weekly_recurring', 'exception') NOT NULL DEFAULT 'specific', \`recurring_day\` int NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_dbe55b925a18314eb9c49ce543\` (\`doctor_id\`, \`date\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`doctor_availability\` (\`id\` int NOT NULL AUTO_INCREMENT, \`doctor_id\` int NOT NULL, \`day_of_week\` enum ('Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday') NOT NULL, \`start_time\` time NOT NULL, \`end_time\` time NOT NULL, \`is_active\` tinyint NOT NULL DEFAULT 1, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`usuarios\` DROP COLUMN \`recordatorio_enviado\``);
        ...
        await queryRunner.query(`ALTER TABLE \`usuarios\` CHANGE \`is_approved\` \`is_approved\` tinyint NOT NULL DEFAULT 1`);
        ...
        await queryRunner.query(`ALTER TABLE \`perfiles_medicos\` CHANGE \`duracion_consulta_default\` \`duracion_consulta_default\` int NOT NULL DEFAULT '20'`);
        ...
        await queryRunner.query(`ALTER TABLE \`pacientes\` ADD \`numero_identificacion\` varchar(255) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`doctor_schedules\` ADD CONSTRAINT \`FK_a9562c0e3b99e62425d3356c88b\` FOREIGN KEY (\`doctor_id\`) REFERENCES \`usuarios\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`doctor_availability\` ADD CONSTRAINT \`FK_2cc8d37cdcb4ecd1e726d6ed304\` FOREIGN KEY (\`doctor_id\`) REFERENCES \`usuarios\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`doctor_availability\` DROP FOREIGN KEY \`FK_2cc8d37cdcb4ecd1e726d6ed304\``);
        ...
        await queryRunner.query(`ALTER TABLE \`pacientes\` CHANGE \`fecha_nacimiento\` \`fecha_nacimiento\` date NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`perfiles_medicos\` CHANGE \`duracion_consulta_default\` \`duracion_consulta_default\` int NOT NULL DEFAULT '60'`);
        ...
        await queryRunner.query(`ALTER TABLE \`usuarios\` DROP COLUMN \`approval_status\``);
        await queryRunner.query(`ALTER TABLE \`usuarios\` ADD \`approval_status\` enum ('pendiente', 'aprobado', 'rechazado') NOT NULL DEFAULT ''aprobado''`);
        await queryRunner.query(`ALTER TABLE \`usuarios\` CHANGE \`is_approved\` \`is_approved\` tinyint(1) NOT NULL DEFAULT '1'`);
        ...
        await queryRunner.query(`ALTER TABLE \`usuarios\` ADD \`recordatorio_enviado\` tinyint(1) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`DROP TABLE \`doctor_availability\``);
        await queryRunner.query(`DROP INDEX \`IDX_dbe55b925a18314eb9c49ce543\` ON \`doctor_schedules\``);
